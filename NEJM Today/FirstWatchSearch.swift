...
class FirstWatchSearch {
    ...
    func getArticles(dateRange: Int) -> [Article] {
        ...
        let url = "https://avelqu6i45.execute-api.us-east-1.amazonaws.com/jwatch_stage/search?articleClass=Medical%20News&query=\(query)&endDate=\(endDate)&format=xml"
