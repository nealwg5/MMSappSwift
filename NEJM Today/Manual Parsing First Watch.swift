//
//  Manual Parsing First Watch.swift
//  NEJM Today
//
...
class FirstWatchArticles {
    ...
    func getArticles(dateRange: Int) -> [Article] {
        ...
        let url = "https://avelqu6i45.execute-api.us-east-1.amazonaws.com/jwatch_stage/search?query=articleClass:%22Medical_News%22&startDate=\(startDate.fullDate)&endDate=\(endDate)&format=xml"
        ...
        ////for (var articleIndex = 0; articleIndex < totalArticles; articleIndex += 1) {
            ...
            extractParaStyle.paragraphSpacingBefore = 20.0
