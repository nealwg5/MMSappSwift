//
//  Manual Parsing Journal Watch.swift
//  NEJM Today
//
...
class JournalWatchArticles {
    ...
    func getArticles(dateRange: Int) -> [Article] {
        ...
        if ((theCache.getCachedArticleTopicSetting().articleSpecialty != "All specialties") && (theCache.getCachedArticleTopicSetting().isData == true)){
            ...
            url = "https://avelqu6i45.execute-api.us-east-1.amazonaws.com/jwatch_stage/search?query=articleClass:%22Summary%22__specialty:%22\(theCache.getCachedArticleTopicSetting().articleSpecialty)%22&&startDate=\(startDate.fullDate)&endDate=\(endDate)&format=xml"
            ...
            //NSLog("URL TEST: \(url), specialty: \(theCache.getCachedArticleTopicSetting().articleSpecialty)")
                ...
                url = "https://avelqu6i45.execute-api.us-east-1.amazonaws.com/jwatch_stage/search?query=articleClass:%22Summary%22&startDate=\(startDate.fullDate)&endDate=\(endDate)&format=xml"
        }
